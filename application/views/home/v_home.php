...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href=<?= base_url("/libs/assets/dist/css/bootstrap.min.css"); ?> rel="stylesheet">
    ...
    <link href=<?= base_url("/libs/assets/css/style.css"); ?> rel="stylesheet">
</head>
<body>
			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				<header class="page-header row justify-center">
					...
					<div class="dropdown user-dropdown col-md-6 col-lg-4 text-center text-md-right"><a class="btn btn-stripped dropdown-toggle" href="https://example.com" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<img src=<?= base_url("libs/img/profile-pic.jpg"); ?> alt="profile photo" class="circle float-left profile-photo" width="50" height="auto">
									...
									<div class="card-block">
										...
										<div class="user-progress justify-center">
											<div class="col-sm-3 col-md-2" style="padding: 0;">
												<img src=<?= base_url("libs/img/profile-pic.jpg"); ?> alt="profile photo" class="circle profile-photo" style="width: 100%; max-width: 100px;">
											</div>
    ...
    <script src=<?= base_url("/libs/assets/js/jquery-3.2.1.min.js"); ?>></script>
    <script src=<?= base_url("/libs/assets/dist/js/bootstrap.min.js")?>></script>
    
    <script src=<?= base_url("/libs/assets/js/chart.min.js")?>></script>
    <script src=<?= base_url("/libs/assets/js/chart-data.js")?>></script>
    <script src=<?= base_url("/libs/assets/js/easypiechart.js")?>></script>
    <script src=<?= base_url("/libs/assets/js/easypiechart-data.js")?>></script>
    <script src=<?= base_url("/libs/assets/js/bootstrap-datepicker.js")?>></script>
    <script src=<?= base_url("/libs/assets/js/custom.js")?>></script>
    <script>
